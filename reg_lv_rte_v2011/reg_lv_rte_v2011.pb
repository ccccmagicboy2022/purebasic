...
DeleteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\11.0")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\11.0", "Path", Result$)
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\11.0", "Version", "11.0.0")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\11.0", "VersionString", "2011")

MessageBox_(#Null, "set labview 2011 run-time path to" + Result$, "..cv..", #MB_OK | #MB_ICONINFORMATION)            
...
; Folding = -
; EnableXP
; UseIcon = Labview_v2011.ico
; Executable = reg_lv_rte_v2011.exe
