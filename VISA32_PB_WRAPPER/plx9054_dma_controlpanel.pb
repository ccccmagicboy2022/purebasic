...
logo.s  = "PLX9054 DMA CONTROLPANEL"
splash_launcher(@logo)

ori_x = (DesktopWidth(0)  - 550)/2
...
plx9054_dma_controlpanel(@card_array() + SizeOf(card_info))
...
;
; PureBUILD Build = 567 [generated by PureBUILD Plugin]
...
; EnableXP
; UseIcon = BIN\DMA.ico
; Executable = Release\plx9054_dma_controlpanel.exe
; CompileSourceDirectory
; EnableCompileCount = 1070
; EnableBuildCount = 542
; EnableExeConstant
; IncludeVersionInfo
