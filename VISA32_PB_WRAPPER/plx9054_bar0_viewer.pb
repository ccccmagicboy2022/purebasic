...
card_array.card_info(1)\title  = @"PLX9054 BAR0"
card_array.card_info(1)\backup1  = $100

pxi_block_access(@card_array() + SizeOf(card_info))

close_wrapper_dll(dll)
...
;
; PureBUILD Build = 61 [generated by PureBUILD Plugin]
; IDE Options = PureBasic 4.60 (Windows - x86)
; CursorPosition = 14
; EnableThread
; EnableXP
; UseIcon = BIN\cv.ico
; Executable = Release\plx9054_bar0_viewer.exe
; CompileSourceDirectory
; EnableCompileCount = 129
; EnableBuildCount = 57
; EnableExeConstant
; IncludeVersionInfo
