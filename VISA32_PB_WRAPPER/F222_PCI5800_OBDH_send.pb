...
send\dword0 = $80000000 ;bit31:lvds_out_enable
send\dword1 = $200000>>2  ;lvds_out_sent_num个dword数
send\dword2 = $8  ;lvds_out_delay, 4MHz clk
send\dword3 = dma_ch0_buffer_header
send\dword4 = $000000FF ;max = 0x7ff
send\dword5 = $0
send\dword6 = $0
send\dword7 = $0
send\dword8 = $0
...
receive\dword0 = $80000001    ;lvds_in_enable + loopback mode
receive\dword1 = $0
receive\dword2 = $0
receive\dword3 = $0
receive\dword4 = $0
...
receive\dword8 = $0
receive\dword9 = $0
set_parameter(card_res, $08, @receive)

viOut32(card_res, #VI_PXI_BAR0_SPACE, #PCI9054_DMAPADR0, dma_ch0_buffer_header)

hwnd  = OpenWindow(#PB_Any, 0, 0, 600, 300, "F222 PCI5800 OBDH模拟器_loopback测试用", #PB_Window_ScreenCentered|#PB_Window_SystemMenu|#PB_Window_MinimizeGadget)
...
receive\dword0 = $80000000    ;lvds_in_enable
receive\dword1 = $0
receive\dword2 = $0
receive\dword3 = $0
receive\dword4 = $0
...
;
; PureBUILD Build = 188 [generated by PureBUILD Plugin]
...
; EnableThread
; EnableXP
; UseIcon = new_icon\PCI5800_OBDH.ico
; Executable = Release\F222_PCI5800_OBDH_send.exe
; SubSystem = UserLibThreadSafe
; CommandLine = visa://192.168.1.2/PXI3::1::INSTR
; CompileSourceDirectory
; EnableCompileCount = 265
; EnableBuildCount = 179
; EnableExeConstant
; IncludeVersionInfo
