...
DeleteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\7.0")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\7.0", "Path", Result$)

MessageBox_(#Null, "set labview v7 run-time path to" + Result$, "..cv..", #MB_OK | #MB_ICONINFORMATION)            
...
; Folding = -
; EnableXP
; UseIcon = Labview_V7.ico
; Executable = reg_lv_rte_v7.exe
