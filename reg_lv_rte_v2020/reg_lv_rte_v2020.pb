...
DeleteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\20.0")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\20.0", "Path", Result$)
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\20.0", "Version", "20.0.1")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\20.0", "VersionString", "2020 SP1")

MessageBox_(#Null, "set labview 2020 SP1 run-time path to" + Result$, "..cv..", #MB_OK | #MB_ICONINFORMATION)            
...
; Folding = -
; EnableXP
; UseIcon = Labview_v2020.ico
; Executable = reg_lv_rte_v2020.exe
