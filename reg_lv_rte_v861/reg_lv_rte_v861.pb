...
DeleteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\8.6")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\8.6", "Path", Result$)
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\8.6", "Version", "8.6.1")
WriteRegKey(#HKEY_LOCAL_MACHINE, "Software\National Instruments\LabVIEW Run-Time\8.6", "VersionString", "8.6.1")

MessageBox_(#Null, "set labview 8.6.1 run-time path to" + Result$, "..cv..", #MB_OK | #MB_ICONINFORMATION)            
...
; Folding = -
; EnableXP
; UseIcon = Labview_v861.ico
; Executable = reg_lv_rte_v861.exe
