  ...
  parameter.s = " a  -t -s -m5  -ag[yyyyMMdd-HHmmss] -x*.bak -n*.xls -n*.xise -n*.ucf -n*.v -n*.bit -n*.mcs -n*.xco -n*.xaw -n*.html -n*.bat -n*.tme -n*.doc -n*.chm -n*.vhd " + Chr(34) + rar_pack_name + Chr(34) + " " + Chr(34) + StringField(current_path, count, "\") + Chr(34)
...
; Folding = -
; EnableXP
; UseIcon = BIN\ISE_PROJECT.ico
; Executable = Release\ISE_PROJECT_FILES_PACKER.exe
; CompileSourceDirectory
; EnableCompileCount = 42
; EnableBuildCount = 23
; EnableExeConstant
; IncludeVersionInfo
